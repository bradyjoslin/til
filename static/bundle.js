...
(function () {
    ...
    const file = "src/ScrollSnapper.svelte";
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(h1, "class", "svelte-14qj8hv");
    			add_location(h1, file, 51, 6, 988);
    			attr_dev(section, "class", "svelte-14qj8hv");
    			add_location(section, file, 50, 4, 972);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "slider svelte-14qj8hv");
    			add_location(div, file, 48, 0, 917);
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<ScrollSnapper> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("ScrollSnapper", $$slots, []);
    ...
    class ScrollSnapper extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$1 = "src/SampleBasicHistogram.svelte";
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(rect, "height", rect_height_value = /*point*/ ctx[1]);
    			attr_dev(rect, "x", rect_x_value = /*i*/ ctx[3] * barWidth);
    			attr_dev(rect, "y", rect_y_value = height - /*point*/ ctx[1]);
    			attr_dev(rect, "fill", "green");
    			attr_dev(rect, "stroke", "#fff");
    			add_location(rect, file$1, 16, 4, 240);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(16:2) {#each points as point, i}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "class", "svelte-17pjkbp");
    			add_location(svg, file$1, 14, 0, 201);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SampleBasicHistogram> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SampleBasicHistogram", $$slots, []);
    	$$self.$capture_state = () => ({ barWidth, height, points });
    	return [points];
    }

    class SampleBasicHistogram extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    const file$2 = "src/SampleHistogram.svelte";
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			rect = svg_element("rect");
    			attr_dev(rect, "x", rect_x_value = /*xScale*/ ctx[5](/*d*/ ctx[25].date));
    			attr_dev(rect, "y", rect_y_value = /*yScale*/ ctx[6](/*d*/ ctx[25][/*city*/ ctx[2]]));
    			attr_dev(rect, "width", "2");
    			attr_dev(rect, "height", rect_height_value = /*height*/ ctx[3] - /*yScale*/ ctx[6](/*d*/ ctx[25][/*city*/ ctx[2]]));
    			attr_dev(rect, "fill", "blue");
    			attr_dev(rect, "stroke", "#fff");
    			add_location(rect, file$2, 469, 6, 12423);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, rect, anchor);
    		},
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t = text(t_value);
    			attr_dev(line, "stroke", "currentColor");
    			attr_dev(line, "x2", "-5");
    			add_location(line, file$2, 485, 8, 12835);
    			attr_dev(text_1, "dy", "0.32em");
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "x", text_1_x_value = "-" + /*margin*/ ctx[4].left);
    			add_location(text_1, file$2, 486, 8, 12882);
    			attr_dev(g, "class", "tick svelte-8bg8e3");
    			attr_dev(g, "opacity", "1");
    			attr_dev(g, "transform", g_transform_value = "translate(0," + /*yScale*/ ctx[6](/*y*/ ctx[22]) + ")");
    			add_location(g, file$2, 484, 6, 12761);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block$2(ctx) {
    	...
    	let line;
    	let text_1;
    	let t_value = /*xLabel*/ ctx[8](/*x*/ ctx[19]) + "";
    	let t;
    	let text_1_x_value;
    	let g_transform_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(line, "stroke", "currentColor");
    			attr_dev(line, "y2", "6");
    			add_location(line, file$2, 497, 8, 13202);
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "y", "9");
    			attr_dev(text_1, "dy", "0.71em");
    			attr_dev(text_1, "x", text_1_x_value = "-" + /*margin*/ ctx[4].left);
    			add_location(text_1, file$2, 498, 8, 13248);
    			attr_dev(g, "class", "tick svelte-8bg8e3");
    			attr_dev(g, "opacity", "1");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*xScale*/ ctx[5](/*x*/ ctx[19]) + ",0)");
    			add_location(g, file$2, 496, 6, 13128);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line);
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(g0, file$2, 466, 2, 12373);
    			attr_dev(path0, "stroke", "currentColor");
    			attr_dev(path0, "d", /*yPath*/ ctx[11]);
    			attr_dev(path0, "fill", "none");
    			add_location(path0, file$2, 481, 4, 12677);
    			attr_dev(g1, "transform", g1_transform_value = "translate(" + /*margin*/ ctx[4].left + ", 0)");
    			add_location(g1, file$2, 480, 2, 12629);
    			attr_dev(path1, "stroke", "currentColor");
    			attr_dev(path1, "d", /*xPath*/ ctx[10]);
    			attr_dev(path1, "fill", "none");
    			add_location(path1, file$2, 493, 4, 13044);
    			attr_dev(g2, "transform", g2_transform_value = "translate(0, " + /*height*/ ctx[3] + ")");
    			add_location(g2, file$2, 492, 2, 13001);
    			attr_dev(svg, "transform", svg_transform_value = "translate(" + /*margin*/ ctx[4].left + ", " + /*margin*/ ctx[4].top + ")");
    			attr_dev(svg, "class", "svelte-8bg8e3");
    			add_location(svg, file$2, 465, 0, 12299);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*xScale, data, yScale, city, height*/ 110) {
    			...
    			if (dirty & /*yScale, yTicks, margin*/ 592) {
    				each_value_1 = /*yTicks*/ ctx[9];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*xScale, xTicks, margin, xLabel*/ 432) {
    ...
    20120930	62.3	55.1	71.9`;
    	...
    	let yScale = linear$1().domain(extentY).range([height - margin.bottom, margin.top]);
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<SampleHistogram> was created with unknown prop '${key}'`);
    	});

    	let { $$slots = {}, $$scope } = $$props;
    	validate_slots("SampleHistogram", $$slots, []);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("extentX" in $$props) extentX = $$props.extentX;
    		if ("xScale" in $$props) $$invalidate(5, xScale = $$props.xScale);
    		if ("extentY" in $$props) extentY = $$props.extentY;
    		...
    		if ("yTicks" in $$props) $$invalidate(9, yTicks = $$props.yTicks);
    		if ("i" in $$props) i = $$props.i;
    		if ("xPath" in $$props) $$invalidate(10, xPath = $$props.xPath);
    		if ("yPath" in $$props) $$invalidate(11, yPath = $$props.yPath);
    	};
    ...
    class SampleHistogram extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    function create_each_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line_1, file$3, 489, 8, 12827);
    			attr_dev(text_1, "dy", "0.32em");
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "x", text_1_x_value = "-" + /*margin*/ ctx[3].left);
    			add_location(text_1, file$3, 490, 8, 12874);
    			attr_dev(g, "class", "tick svelte-8bg8e3");
    			attr_dev(g, "opacity", "1");
    			attr_dev(g, "transform", g_transform_value = "translate(0," + /*yScale*/ ctx[5](/*y*/ ctx[23]) + ")");
    			add_location(g, file$3, 488, 6, 12753);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line_1);
    ...
    function create_each_block$3(ctx) {
    	...
    	let line_1;
    	let text_1;
    	let t_value = /*xLabel*/ ctx[8](/*x*/ ctx[20]) + "";
    	let t;
    	let text_1_x_value;
    	let g_transform_value;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(line_1, file$3, 501, 8, 13194);
    			attr_dev(text_1, "fill", "currentColor");
    			attr_dev(text_1, "y", "9");
    			attr_dev(text_1, "dy", "0.71em");
    			attr_dev(text_1, "x", text_1_x_value = "-" + /*margin*/ ctx[3].left);
    			add_location(text_1, file$3, 502, 8, 13240);
    			attr_dev(g, "class", "tick svelte-8bg8e3");
    			attr_dev(g, "opacity", "1");
    			attr_dev(g, "transform", g_transform_value = "translate(" + /*xScale*/ ctx[4](/*x*/ ctx[20]) + ",0)");
    			add_location(g, file$3, 500, 6, 13120);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, g, anchor);
    			append_dev(g, line_1);
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(path0, "d", path0_d_value = /*path*/ ctx[6](/*data*/ ctx[1]));
    			attr_dev(path0, "fill", "none");
    			attr_dev(path0, "stroke", "blue");
    			add_location(path0, file$3, 480, 4, 12543);
    			add_location(g0, file$3, 478, 2, 12517);
    			attr_dev(path1, "stroke", "currentColor");
    			attr_dev(path1, "d", /*yPath*/ ctx[11]);
    			attr_dev(path1, "fill", "none");
    			add_location(path1, file$3, 485, 4, 12669);
    			attr_dev(g1, "transform", g1_transform_value = "translate(" + /*margin*/ ctx[3].left + ", 0)");
    			add_location(g1, file$3, 484, 2, 12621);
    			attr_dev(path2, "stroke", "currentColor");
    			attr_dev(path2, "d", /*xPath*/ ctx[10]);
    			attr_dev(path2, "fill", "none");
    			add_location(path2, file$3, 497, 4, 13036);
    			attr_dev(g2, "transform", g2_transform_value = "translate(0, " + /*height*/ ctx[2] + ")");
    			add_location(g2, file$3, 496, 2, 12993);
    			attr_dev(svg, "transform", svg_transform_value = "translate(" + /*margin*/ ctx[3].left + ", " + /*margin*/ ctx[3].top + ")");
    			attr_dev(svg, "class", "svelte-8bg8e3");
    			add_location(svg, file$3, 477, 0, 12443);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			/*svg_binding*/ ctx[19](svg);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*yScale, yTicks, margin*/ 552) {
    				each_value_1 = /*yTicks*/ ctx[9];
    				validate_each_argument(each_value_1);
    				let i;
    			...
    			if (dirty & /*xScale, xTicks, margin, xLabel*/ 408) {
    				each_value = /*xTicks*/ ctx[7];
    				validate_each_argument(each_value);
    				let i;
    ...
    20120930	62.3	55.1	71.9`;
    	...
    	let extentY = extent(data, d => d[city]);
    	let yScale = linear$1().domain(extentY).range([height - margin.bottom, margin.top]);
    	let path = line().x(d => xScale(d.date)).y(d => yScale(d[city])).curve(curveStep);
